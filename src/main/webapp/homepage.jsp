...
<div style="background-color:grey; color:white; padding:10px;">
    ...
    <form name="headform">
            ...
            Логин:<input type="text"  name="txtusername" value="${user.username}" placeholder="Логин" />
            Пароль:<input type="password" name="txtpassword" value="${user.password}" placeholder="Пароль" />
...
<table style="width:25%">
    ...
    <tr><td>Имя:</td><td><input type="text" name="txtfirstname" value="${user.firstName}" placeholder="Имя" /></td></tr>
    <tr><td>Фамилия:</td><td><input type="text" name="txtlastname" value="${user.lastName}" placeholder="Фамилия" /></td></tr>
</table>
